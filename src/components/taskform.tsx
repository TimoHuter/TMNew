            ...
            {mode !== -1 && loading === false && (
                <form onSubmit={handleSubmit} className="container-item space-y-2 p-4 w-full">
                    <div className="grid w-full max-w-sm items-center gap-3">
                        ...
                        <Input type="text" maxLength={64} id="title" placeholder="Title" value={title} onChange={(e) => setTitle(e.target.value)} />
                    </div>

                    <div className="grid w-full gap-3">
                        <Label htmlFor="description">Description</Label>
                        <Textarea className="w-[24rem]" maxLength={2056} id="description" placeholder="Your description" value={description} onChange={(e) => setDescription(e.target.value)} />
                        {/*<p>{2056 - (description.length)}</p>*/}
                    </div>
